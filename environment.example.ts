export const environment = {
  prod: true,
  // this makes the logs really heavy
  logSQLQueries: false,
  ...
  // You should run also this project github.com/gabboman/fediversemediacacher. In my case, https://cache.wafrn.net/?media=
  ...
  postsPerPage: 20,
  // The frontend files. Used if you route some things like /post/ through this. Read the manual because there is a way of updating the front without downtime
